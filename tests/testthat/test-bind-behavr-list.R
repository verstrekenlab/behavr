...
test_that("all_identical utility", {
  ...
  expect_true(fslbehavr::all_identical(l1))
  expect_false(fslbehavr::all_identical(l2))
  expect_false(fslbehavr::all_identical(l3))
  expect_true(fslbehavr::all_identical(l4))
})
